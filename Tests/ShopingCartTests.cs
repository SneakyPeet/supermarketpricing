    ...
    public class ShopingCartTestCaseFactory
    {
        public static IEnumerable TestCases
        {
            get
            {
                ...
                yield return new TestCaseData(new List<Product> { MakeBuy2OneFree(), MakeBuy2OneFree() }, 200, "Buy Two Get One Free should return correct Price");
                yield return new TestCaseData(new List<Product> { MakeBuy2OneFree(), MakeBuy2OneFree(), MakeBuy2OneFree() }, 200, "Buy Two Get One Free should return correct Price");
                yield return new TestCaseData(new List<Product> { MakeBuy2OneFree(), MakeBuy2OneFree(), MakeBuy2OneFree(), MakeBuy2OneFree() }, 300, "Buy Two Get One Free should return correct Price");
                yield return new TestCaseData(new List<Product> { MakeBuy2OneFree(), MakeBuy2OneFree(), MakeBuy2OneFree(), MakeBuy2OneFree(), MakeBuy2OneFree(), MakeBuy2OneFree(), MakeBuy2OneFree() }, 500, "Buy Two Get One Free should return correct Price");
            }
        }
